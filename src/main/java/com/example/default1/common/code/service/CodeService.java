package com.example.default1.common.code.service;

import com.example.default1.common.code.mapper.CodeMapper;
...
public class CodeService {
    ...
    public void createCode(Code code) {
        if(code.getCodeGroupId() == null) {
            throw new CustomException(2800, "codeGroupId가 입력되지 않았습니다.");
        }

        CodeGroup codeGroup = codeMapper.selectCodeGroupById(code.getCodeGroupId());
        if(codeGroup == null) {
            throw new CustomException(2800, "codeGroupId에 해당하는 그룹이 없습니다.");
        }
